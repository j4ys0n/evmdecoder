...
test('parseSignature', () => {
  ...
  expect(() => parseFunctionSignature('foo(int)(uint)')).toThrowErrorMatchingInlineSnapshot(`"Unbalanced parenthesis"`)
...
test('sha3', () => {
  ...
  expect(sha3('0x123z')).toMatchInlineSnapshot(`"0xea7d953054ed3082a5213c6e79bc8f76c7cdfed74690fc45ce903e2c9401e3a9"`)
})
